   ...
   <head>
     ...
     <body class="sb-nav-fixed">
         <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
             <a class="navbar-brand" href="{{ url('/')}}"><img src="{{ asset('images/mf_white1_.png') }}" alt="MF.logo" width="60%"></a>
                               ...
                               <div class="row">
                                 <div class="col-6">
                                   <div class="container-fluid profile-image-container">
                                     ...
                                     <form class="" action="{{route('editcoverimage')}}" method="post" enctype="multipart/form-data" id="imgupload">
