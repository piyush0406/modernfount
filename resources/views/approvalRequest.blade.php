...
<html lang="en">
   ...
   <head>
      ...
      <title>Approval Request | Modern Fount</title>
               ...
               <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                   <div class="sb-sidenav-menu">
                       <div class="nav">
                           ...
                           <a class="nav-link active" href="{{ url('/admin/approval-request')}}">
             ...
             <div id="layoutSidenav_content">
                 <main>
                   <div class="container-fluid">
                       <h1 class="mt-4">Approval Request</h1>
                       <ol class="breadcrumb mb-4">
                           <li class="breadcrumb-item"><a href="{{ url('/admin')}}">Home</a></li>
                           <li class="breadcrumb-item active">Approval Request</li>
                       </ol>
                          @php
                              $articleTable=App\Http\Controllers\Api\ArticleController::unapproveArticle();
                              $count=1;
                          @endphp
                       <table class="table table-sm table-light table-hover">
                        <thead class="thead-light">
                          <tr >
                            ...
                            <th scope="col" class="auto-table-w">Approve</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <form class="" action="{{route('articlestatus')}}" method="post">
                              <div class="hiddenInfo">
                                ...
                                <input type="text" name="secondary_article" value="0">
                                <input type="text" name="author_id" value="{{$article['author_id']}}">
                              </div>
                            <td class="text-center"><button type="submit" class="btn btn-success"><i class="fa fa-check"></i></button></td>
                            </form>
                            <form class="" action="{{route('deletearticleUn')}}" method="post">
                              <div class="hiddenInfo">
                                <input type="text" name="id" value="{{$article['id']}}">
                              </div>
